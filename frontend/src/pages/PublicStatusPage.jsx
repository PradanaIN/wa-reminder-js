  ...
  return (
    <PublicLayout>
      <section id="status" className="space-y-12">
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-xl space-y-5">
              ...
              <p className="text-base text-slate-400">
                Sistem ini mengatur jadwal pengiriman otomatis, override manual,
                serta status koneksi bot. Nikmati transparansi penuh mengenai
                kapan pesan terakhir dikirim dan kapan pengiriman berikutnya
                akan dilakukan.
              </p>
              <div className="flex flex-wrap items-center gap-3 text-sm text-slate-300">
                {healthLoading ? (
                  ...
                  <StatusPill active={Boolean(health?.botActive)} />
                )}
              ...
              <div className="flex items-center justify-between">
                ...
                {healthLoading ? (
                  ...
                  <span className="font-semibold text-white">
                    {health?.botActive ? "Aktif" : "Nonaktif"}
                  </span>
                )}
              </div>
              <div className="flex items-center justify-between">
        ...
        {/* CTA Card */}
        <Card className="flex flex-col items-center gap-4 rounded-2xl bg-slate-900/80 py-10 text-center shadow-lg backdrop-blur-md">
          <h2 className="text-2xl font-semibold text-white">
            Ingin menyesuaikan jadwal?
          </h2>
          <p className="max-w-2xl text-sm text-slate-300">
            Masuk sebagai admin untuk mengatur jadwal default per hari,
            menambahkan override manual untuk tanggal tertentu, serta
            menjalankan bot secara langsung.
          </p>
          <a
            href="/admin/login"
            className="rounded-full bg-primary-500 px-6 py-2 text-sm font-semibold uppercase tracking-wide text-white shadow-lg shadow-primary-500/30 transition hover:scale-105 hover:bg-primary-400 hover:shadow-primary-400/40"
          >
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="text-base text-slate-400">
                  ...
                  pengingat ke tim Anda. Override manual akan menggantikan
                  jadwal di tanggal tertentu, tetapi akan kembali ke pola
                  default setelahnya.
                </p>
              </div>
              ...
              <p className="text-sm text-slate-400">
                Untuk mengubah jam pengiriman atau menambah override manual,
                masuk ke dashboard admin dan atur jadwal sesuai kebutuhan
                operasional Anda.
              </p>
            </div>
